...
const isValidValue = (value) => {
  ...
  export default function Discipline_Data_List() {
  Discipline_Data_List.title = "Discipline Data List"
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorFn: (row) => row.discipline_name,
        id: "discipline_name",
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${API_URL}/public/master_discipline`,
          {
            params: {
...
Discipline_Data_List.isPublic = true
Discipline_Data_List.getLayout = function getLayout(page) {
