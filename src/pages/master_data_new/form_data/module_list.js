...
export default function Module_List() {
  Module_List.title = "Module Data List"
...
Module_List.isPublic = true
Module_List.getLayout = function getLayout(page) {
