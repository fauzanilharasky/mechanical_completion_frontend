...
export default function Phase_List() {
  Phase_List.title = "Phase Data List"
  ...
  return (
    <div className="py-6">
      <div className="max-w-full mx-auto sm:px-6 lg:px-12 py-10">
...
Phase_List.isPublic = true
Phase_List.getLayout = function getLayout(page) {
