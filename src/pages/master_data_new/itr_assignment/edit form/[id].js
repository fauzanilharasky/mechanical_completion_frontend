...
export default function Assignment_Itr_edit() {
  ...
  const handleUpdate = async (rowId, columnId, value) => {
    try {
      ...
      console.error(error)
      Swal.fire('Error', 'Failed To Updated Data', 'error')
    }
  }
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        header: 'Status',
        cell: (info) =>
          info.getValue() === 1 || info.getValue() === '1'
            ? 'Active'
            : 'Inactive',
      },
    ],
          ...
          <Paper radius="sm" mt="md" withBorder>
            <div className="p-4 border-b flex justify-between">
              ...
              <Button
                ...
                onClick={async () => {
                  await fetchBulkData() 
                  Swal.fire('Success', 'Perubahan sudah disimpan!', 'success')
                  setHasChanges(false)
                }}
              >
                Update
            ...
            <h1 className="text-center font-bold py-2">EDIT TAG NUMBER</h1>
