...
ClientRejectDetails.title = "Details Inspection By Client"
export default function ClientRejectDetails() {
...
const fetchDetails = async () => {
  ...
  try {
    ...
    const list = (res.data.data || []).filter(
      row => Number(row.status_inspection) === 7
    );
          ...
          <Paper radius="sm" mt="md" style={{ position: 'relative' }} withBorder>
            ...
            <div className="px-4 py-2 text-left">
              <Button
                ...
                color="red"
                variant="outline"
                onClick={() => router.push('/master_data_new/rfi_submission/client_section/reject_client')}
            ...
            <Accordion.Panel>
              ...
              <div className="flex justify-between mb-4 mt-3">
                ...
                <Button.Group>
                  ...
                  onClick={() => handleSelectAll(row.tag_number, "OK")}>
                    OK All
                  </Button>
                  <Button 
                  color="blue"
                  
                  onClick={() => handleSelectAll(row.tag_number, "NA")}>
                    NA All
                  </Button>
                  <Button 
                  color="orange" 
                  
                  onClick={() => handleSelectAll(row.tag_number, "PL")}>
                    PL All
                  </Button>
                </Button.Group>
              </div>
