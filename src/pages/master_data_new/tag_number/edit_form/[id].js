...
Tag_number_edit.title = 'Tag Number Edit'

export default function Tag_number_edit() {
    ...
    if (router.query.id && user?.token) {
      ...
      try {
        const res = await axios.post(
          `${API_URL}/api/pcms_mc_template/bulk_find`,
          { ids },
          { headers: { Authorization: `Bearer ${user.token}` } }
        )
        setData(res.data || [])
          ...
          <Paper radius="sm" mt="md" withBorder>
            <div className="p-4 border-b flex justify-between">
              ...
              >
               ...
               <h1 className="text-center font-bold py-2 text-2xl">EDIT TAG NUMBER</h1>
              <Button
